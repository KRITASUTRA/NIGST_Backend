...
const { createAboutImage, viewImages, viewWebImages,deleteImages, updateVisibleImages } = require('../../controllers/aboutSectionImage')
...
router.post('/create_banner', LimitUpload,bannerUpload, createBanner)
...
router.post('/create_album', LimitUpload,galleryUpload, createAlbum)
router.get('/view_album', viewAlbum)


router.post('/create_project', LimitUpload,SOI_PROJECT_UPLOAD, createProject)
...
router.post('/create_header', LimitUpload,headerUpload, HeaderCreate)
...
router.post('/create_sports_facility',LimitUpload,sportsFacility,createSportsFacility);
router.get('/view_sports_facility',viewSportsFacility);
router.get('/view_web_sports_facility',viewWebSportsFacility);
router.patch('/update_sports_facility',LimitUpload,sportsFacility,updateSportsFacility);
...
router.post('/create_nigst_hostel',LimitUpload,nigstHostell,createNigstHostel);
router.get('/view_nigst_hostel',viewNigstHostel);
router.get('/view_web_nigst_hostel',viewWebNigstHostel);
router.patch('/update_nigst_hostel',LimitUpload,nigstHostell,updateNigstHostel);
...
router.patch('/update_governance',LimitUpload,boardGovernancee,updateGovernance)
router.delete('/delete_governance',deleteGovernance)
router.patch('/update_visible_governance',updateVisibleGovernance)

router.post('/create_evaluation',LimitUpload,boardOfEvaluation,createEvaluation)
...
router.post('/create_about_section_image',LimitUpload,aboutSectionImage,createAboutImage)
